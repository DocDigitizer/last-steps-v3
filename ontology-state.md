...
- [x] 2. Finance, Accounting & Tax
  ...
  - **Invoicing & Payments** — Documents that request, confirm, or record the exchange of monetary value for goods or services. Scope: invoices, receipts, payment confirmations, credit/debit notes, billing statements.
...
- [x] 4. Operations & Corporate Governance
...
- [x] 5. Human Resources & Employment
...
- [x] 6. Sales, Marketing & Procurement
...
- [x] 8. Government & Public Administration
...
- [x] 10. Technical & Product Documentation
...
#### 4. Operations & Corporate Governance

**4.1 Standard Operating Procedures** → **LEAF** — Prescriptive procedural documents sharing a common structure of purpose, scope, step-by-step instructions, and responsibilities.
...
**4.4 Internal Policies** → **LEAF** — Organization-wide policy documents sharing a common structure of policy statement, scope, applicability, compliance requirements, and enforcement.

**4.5 Logistics & Supply Chain** → BRANCH
...
**5.1 Recruitment & Talent Acquisition** → BRANCH
...
**5.3 Compensation & Benefits** → BRANCH
...
**5.4 Performance Management** → BRANCH
...
**5.5 Training & Development** → BRANCH
...
**6.2 Marketing & Communications** → BRANCH
...
**6.3 Procurement & Vendor Management** → BRANCH
...
**7.5 Healthcare Administration** → BRANCH
...
**8.4 Public Policy & Legislation** → BRANCH
...
**8.5 Government Correspondence** → BRANCH
...
**9.2 Curriculum & Instruction** → BRANCH
...
**9.3 Scientific Research** → BRANCH
...
**9.5 Institutional Administration** → BRANCH
...
**10.1 System & Architecture** → BRANCH
...
**10.2 API & Developer Documentation** → BRANCH
...
**10.4 User-Facing Documentation** → BRANCH
...
**10.5 Operational Runbooks** → **LEAF** — Procedural documents sharing a common structure of trigger/condition, step-by-step actions, escalation paths, and rollback procedures.
...
### Level 4+ Expansion
*(Not currently needed — all Level 3 nodes are marked as LEAF. If schema definition reveals any leaf is still too broad, it can be split further here.)*
